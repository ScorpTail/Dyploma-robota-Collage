...
return [
    ...
    */
    ...
    'alpha_num' => 'Поле :attribute має містити лише літери, цифри, тире та підкреслення.',
    ...
    'between' => [
        ...
        'numeric' => 'Поле :attribute повинно містити від :min до :max кілобайт.',
        'string' => 'Поле :attribute повинно містити від :min до :max.',
    ],
    ...
    'gt' => [
        ...
        'numeric' => 'Поле :attribute має бути більшим за :value кілобайтів.',
        'string' => 'Поле :attribute має бути більшим за :value.',
    ],
    'gte' => [
    ...
    */
    ...
    'custom' => [
        ...
        'price' => [
            'gt' => 'поле :attribute повинне бути більше за :value.',
        ],
    ],
