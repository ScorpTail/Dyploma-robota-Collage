            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="pt-3 col-12 card card-primary">
                        ...
                        <form action="{{route("user.user-cabinet.order.update", $service)}}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                {{--                                        <option @selected(1 == $service->status) value="1">Нове</option>--}}
                                {{--                                        <option @selected(2 == $service->status) value="2">Б/У</option>--}}
                                {{--                                    </select>--}}
                                {{--                                    @error("status")--}}
                                {{--                                    <div class="text-danger">{{$message}}</div> @enderror--}}
                                {{--                                </div>--}}
                                ...
                                <div class="card">
                                    <button type="submit" class="btn btn-primary">Редагувати послугу</button>
                                </div>
                            </div>
                        </form>
                    </div>
